...
public class ExpendableAdapter extends BaseExpandableListAdapter {
    ...
    public ExpendableAdapter(Context context, String[] listDataHeader,
    ...
    public Object getChild(int groupPosition, int childPosititon) {
        return this._listDataChild[groupPosition][childPosititon];
    }
    ...
    public int getChildrenCount(int groupPosition) {
        return this._listDataChild[groupPosition].length;
    }
